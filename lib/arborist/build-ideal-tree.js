...
module.exports = cls => class IdealTreeBuilder extends cls {
  ...
  async [_buildRosetteQuery] () {
    ...
    // const KNOWN_KEYS_TMP = [
    //   "@stopify/project-interpreter",
    ...
    // const KNOWN_SET_TMP = new Set(KNOWN_KEYS_TMP)
    // const actualKeys = new Set(Object.keys(reachableRegistry))
    // if(!(isSubset(KNOWN_SET_TMP, actualKeys) && isSubset(actualKeys, KNOWN_SET_TMP))) {
    //   throw new Error("BAD!")
    // }
