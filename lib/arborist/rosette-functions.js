...
const ROSETTE_FUNCTIONS_JSON = {
  "constraintInterpretation": constraintInterpretation.toJSON(),
  "consistency": npmConsistency.toJSON(),
  "versionDeserialize": versionDeserialize.toJSON(),
  "versionSerialize": versionSerialize.toJSON(),
}

module.exports = {
  ROSETTE_FUNCTIONS_JSON,
}